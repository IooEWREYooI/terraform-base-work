# Домашнее задание к занятию «Управляющие конструкции в коде Terraform» - Мануилов Яков
...
Для того чтобы terraform init использовать нужно было .terraformrc переместить в ~ или home/user
